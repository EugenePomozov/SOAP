...
public class CustomerServiceImplServiceLocator extends org.apache.axis.client.Service implements by.epamlab.CustomerServiceImplService {
    ...
    private java.lang.String CustomerServiceImplPort_address = "http://localhost:8080/Soap/service";
    ...
    public by.epamlab.CustomersService getCustomerServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public by.epamlab.CustomersService getCustomerServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            by.epamlab.CustomerServiceImplPortBindingStub _stub = new by.epamlab.CustomerServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (by.epamlab.CustomersService.class.isAssignableFrom(serviceEndpointInterface)) {
                by.epamlab.CustomerServiceImplPortBindingStub _stub = new by.epamlab.CustomerServiceImplPortBindingStub(new java.net.URL(CustomerServiceImplPort_address), this);
                _stub.setPortName(getCustomerServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://epamlab.by/", "CustomerServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://epamlab.by/", "CustomerServiceImplPort"));
        }
