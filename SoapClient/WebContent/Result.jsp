...
<jsp:useBean id="sampleCustomersServiceProxyid" scope="session" class="by.epamlab.CustomersServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        by.epamlab.CustomersService getCustomersService10mtemp = sampleCustomersServiceProxyid.getCustomersService();
...
case 15:
        ...
        %>
        <jsp:useBean id="by1epamlab1Customer_1id" scope="session" class="by.epamlab.Customer" />
        <%
        by1epamlab1Customer_1id.setEMail(eMail_2idTemp);
        by1epamlab1Customer_1id.setPhone(phone_3idTemp);
        by1epamlab1Customer_1id.setName(name_4idTemp);
        by1epamlab1Customer_1id.setId(id_5idTemp);
        boolean addNewCustomer15mtemp = sampleCustomersServiceProxyid.addNewCustomer(by1epamlab1Customer_1id);
...
case 39:
        ...
        by.epamlab.Customer getCustomerById39mtemp = sampleCustomersServiceProxyid.getCustomerById(arg0_10idTemp);
...
case 52:
        gotMethod = true;
        by.epamlab.Customer[] getAllCustomer52mtemp = sampleCustomersServiceProxyid.getAllCustomer();
